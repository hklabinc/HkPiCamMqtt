...
def proc_mqtt_motion_face(frame):
    global past1, past2, past3
    ...
    if isEvent:
        img_first = frame  # 1번째 프레임 읽기
        img_second = frame  # 2번째 프레임 읽기
...
def Process():
    ...
    while True:      
        ...
        if q.empty() != True:       
            ...
            proc_mqtt_motion_face(frame_iamge)
                
            # cv2.imshow("Video_detected", frame_iamge)       # Show the image 
